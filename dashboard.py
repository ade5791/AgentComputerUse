...
def load_dashboard():
    ...
    with col1:
        ...
        session_replay.add_replay_button_to_session(selected_session_id, st, button_suffix="overview_tab")
    ...
    with tab2:
        ...
        if screenshots:
            ...
            session_replay.add_replay_button_to_session(selected_session_id, st, button_suffix="screenshots_tab")
    ...
    with tab4:
        ...
        if reasoning_data:
            ...
            session_replay.add_replay_button_to_session(selected_session_id, st, button_suffix="reasoning_tab")
